...
class _RecapScreenState extends State<RecapScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _loading 
          ...
          : _recap == null || _recap!.totalTracksPlayed == 0 
              ? _emptyState() 
              : RefreshIndicator(
                  onRefresh: _load, 
                  child: _mainList(theme),
                ),
    );
  }
  ...
  Widget _emptyState() => const Center(
    child: Column(
      ...
      children: const [
        ...
        SizedBox(height: 16), 
        Text("No listening data yet!", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)), 
        Text("Listen to some music and come back.", style: TextStyle(color: Colors.grey))
      ],
    ),
  );

  Widget _mainList(ThemeData theme) => ListView(
    ...
    children: [
      ...
      // Top Artists (Properly formatted)
  ...
  Widget _statCard(String t, String v, IconData i, Color c) => Expanded(
    child: Container(
      padding: const EdgeInsets.all(16), 
      decoration: BoxDecoration(
      ...
      child: Column(
        ...
        children: [
          const Padding(
            ...
            child: Text("Recap Settings", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)
          ),
          Padding(
      ...
      _Slide(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16), 
            Text("${recap.periodLabel} Recap", style: const TextStyle(color: Colors.white, fontSize: 32, fontWeight: FontWeight.bold)), 
      ...
      _Slide(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(recap.hoursListened.toStringAsFixed(1), style: const TextStyle(color: Colors.white, fontSize: 80, fontWeight: FontWeight.bold, height: 1)), 
        ...
        child: Column(
          ...
          children: [
            ...
            CircleAvatar(
              ...
              backgroundImage: recap.topArtists.isNotEmpty && recap.topArtists.first.imageUrl != null ? NetworkImage(recap.topArtists.first.imageUrl!) : null
            ), 
            const SizedBox(height: 16), 
            Text(
      ...
      _Slide(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("${recap.currentStreak} Days", style: const TextStyle(color: Colors.white, fontSize: 60, fontWeight: FontWeight.bold)), 
            Text("Longest: ${recap.longestStreak} days", style: const TextStyle(color: Colors.white70))
          ],
        )
      ),
      _Slide(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16), 
            Text(recap.mood, style: const TextStyle(color: Colors.white, fontSize: 36, fontWeight: FontWeight.bold))
          ],
        )
      ),
      _Slide(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("${recap.newArtistsDiscovered}", style: const TextStyle(color: Colors.white, fontSize: 60, fontWeight: FontWeight.bold)), 
  ...
  Widget build(BuildContext context) { 
    ...
    return Wrap(
      ...
      children: daily.map((d) { 
        ...
        return Tooltip(
          message: "${d.date.day}/${d.date.month}\n${d.listeningTimeMs ~/ 60000} min", 
          child: Container(
            width: 14, 
            height: 14, 
            decoration: BoxDecoration(
              color: d.listeningTimeMs > 0 ? color.withOpacity(0.2 + (op * 0.8)) : Colors.grey.withOpacity(0.1), 
